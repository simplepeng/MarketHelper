...
object MarketHelper {
    ...
    //key=系统，value=商店包名
    private val marketPkgMap = TreeMap<String, Array<String>>(String.CASE_INSENSITIVE_ORDER)
